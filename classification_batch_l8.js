var landsat_lib = require('users/dyedenm/urban:mapbiomas-c4/landsat_lib');
...
var ExportImage = function(image, geometry, grid, year){

  var imageName = "URBAN_" + grid + "_" + String(year);
  
  Export.image.toAsset({
      "image": image,
      "assetId":"projects/mapbiomas-workspace/TRANSVERSAIS/INFRAURBANA5/INFRAURBANA5-PROB-V6/" + imageName,
...
listGrid_1.forEach(function(grid){
    ...
    ExportImage(classified,carta_hex.geometry(),grid,year);
